...
class Player:
    ...
    def __init__(self, game):
        """`game` - `Gomoku` instance this player belong to (more precisely its weakref.proxy)"""
        self.game = game
...
Stone in `position` originally played by player with `player_index` has been removed."""
    ...
    def choose(self):
        """Called after opponent's swap: return the index of the player whose stones you want to play with."""
